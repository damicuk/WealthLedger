...
var IncomeLot = class IncomeLot {
   ...
   * @param {number} exRate - he income asset to fiat base exchange rate, 0 if the income asset is fiat base.
   * @param {number} amount - The amount of income in asset units.
   * @param {string} walletName - The name of the wallet (or exchange) where the income was credited.
   */
  constructor(date, sourceAsset, incomeAsset, exRate, amount, walletName) {
    ...
    /**
     * The income asset to fiat base exchange rate, 0 if the income asset is fiat base.
     * @type {number}
     */
    this.exRate = exRate;
